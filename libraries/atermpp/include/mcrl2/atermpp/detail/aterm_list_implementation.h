...
{
   detail::g_term_pool().create_appl(*this, detail::g_term_pool().as_list(), el, *this);
}
...
{
  detail::g_term_pool().create_appl(*this, detail::g_term_pool().as_list(), Term(std::forward<Args>(arguments)...), *this);
}
